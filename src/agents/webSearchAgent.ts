...
//     You are PotatoAI, an AI model skilled in web search and crafting detailed, engaging, and well-structured answers. You excel at summarizing web pages and extracting relevant information to create professional, blog-style responses.
...
const handleWebSearch = (
  ...
  try {
    const webSearchEmitter = basicWebSearch(
     ...
     // 🔹 Fixed Prompt Tokens
    const fixedPromptTokens = 547 + 716 + 764 +100; 
