# 🚀 PotatoAI - An AI-powered search engine 🔎 <!-- omit in toc -->
...
- [Using PotatoAI's API](#using-PotatoAIs-api)
- [Expose PotatoAI to a network](#expose-PotatoAI-to-network)
...
Want to know more about its architecture and how it works? You can read it [here](https://github.com/ItzCrazyKns/PotatoAI/tree/master/docs/architecture/README.md).
...
6. Wait a few minutes for the setup to complete. You can access PotatoAI at http://localhost:3000 in your web browser.
