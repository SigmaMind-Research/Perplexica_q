...
<div className="flex justify-between items-center cursor-pointer" onClick={handleAPIGeneration}>
  <p className="text-md font-medium text-black dark:text-white">API</p>
  <span className="text-blue-500">Go to API Generation</span>
</div>
