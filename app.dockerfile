...
ARG NEXT_PUBLIC_WS_URL=wss://testpotatoai-cwgvbjgybbgme8b7.centralindia-01.azurewebsites.net
ARG NEXT_PUBLIC_API_URL=https://testpotatoai-cwgvbjgybbgme8b7.centralindia-01.azurewebsites.net/api
